...
# Print the current user and directory
prompt_dir() {
  # Root username: yellow
  # Normal username: blue
  # Directory: always green
  echo "%(!.%{$fg[yellow]%}.%{$fg[blue]%})%n%{$reset_color%}:%{$fg[green]%}%~%{$reset_color%}"
}
