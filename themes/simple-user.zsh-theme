# Prompt with time, environments, user, path, and Git status.
# Format: [MM/DD HH:MM] (<conda>) (<uv>) <user> <path> (<branch> ✔)
...
# Build the prompt.
PROMPT='$(prompt_time)$(prompt_conda)$(prompt_uv)$(prompt_user)$(prompt_dir)$(git_prompt_info)%{$reset_color%} '
