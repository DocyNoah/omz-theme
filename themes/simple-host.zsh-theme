# Prompt with time, environments, host, path, and Git status.
# Format: [MM/DD HH:MM] (<conda>) (<uv>) <host> <path> (<branch> ✔)
...
# Build the prompt.
PROMPT='$(prompt_time)$(prompt_conda)$(prompt_uv)$(prompt_host)$(prompt_dir)$(git_prompt_info)%{$reset_color%} '
